...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarColor02">
    ...
    <form id='search' class="form-inline my-2 my-lg-0">
      ...
      <button class="btn btn-secondary my-2 my-sm-0" type="submit" onclick="doQuery()">Search</button>
    </form>
  </div>
</nav>
<!-- Main Image -->
...
s.src = 'https://gamebuddy.disqus.com/embed.js';
...
<div class="footer-basic">
  <footer>
    ...
    <script id="dsq-count-scr" src="//gamebuddy.disqus.com/count.js" async></script>
  </body>
</html>
